      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome Bahri</h3>
                 </div>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                    <h2 class="fs-30 mb-2">Jumlah Pendaftar</h2>
                      <h2 class="mb-4"><?php echo $row['total_siswa'];?></h2>
                      <p></p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <h2 class="fs-30 mb-2">Jumlah Jurusan</h2>
                      <h2 class="mb-4">5</h2>
                      <p></p>
                    </div>
                  </div>
          ...
          <?php
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <h2 class="fs-30 mb-2">income harian</h2>
                      <h2 class="mb-4">Rp. <?php echo number_format($total_income,0,',','.');?></h2>
                      <p></p>
                    </div>
                  </div>
                </div>
        ...
        <?php
          ...
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block"style="font-size:20px;">RP.<?php echo $row['total_pengurangan'];?></span> 
          </div>
        </footer> 
        <!-- partial -->
      </div>
